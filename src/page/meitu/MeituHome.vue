<template>
  <div class="meitu-home">
    ...
    <div class="main">
      <div class="meinv" v-loading="loading">
        <h4>热门美女</h4>
        <el-row>
      ...
      <div class="latest" v-loading="loading">
        <h4>最新发布</h4>
        <el-row>
      ...
      <div class="site-tag" v-loading="loading">
        <h4>名站写真</h4>
        <el-row>
...
export default {
  ...
  data () {
    return {
      imgUrl: 'http://10.30.4.181:3000/api/other/meitulu/getimg?url=',
      carData: [
        {index: 1, img: 'http://10.30.4.181:3000/api/other/meitulu/getimg?url=https://mtl.ttsqgs.com/pic/4044.jpg'},
        {index: 2, img: 'http://10.30.4.181:3000/api/other/meitulu/getimg?url=https://mtl.ttsqgs.com/pic/3583.jpg'},
        {index: 3, img: 'http://10.30.4.181:3000/api/other/meitulu/getimg?url=https://mtl.ttsqgs.com/pic/4514.jpg'},
        {index: 4, img: 'http://10.30.4.181:3000/api/other/meitulu/getimg?url=https://mtl.ttsqgs.com/pic/224.jpg'},
      ],
      homeData: {
        meinv: [],
        hot: [],
  ...
  methods: {
    getHomeInfo() {
      let url = 'http://10.30.4.181:3000/api/other/meitulu/site'
